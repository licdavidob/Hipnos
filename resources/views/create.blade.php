    ...
    <div class="p-10 m-5">
        <div class="shadow-md backdrop-blur-sm shadow-gray-400">
            <div class="relative flex justify-end w-full -right-5">
                <p class="py-3 w-60 my-4 text-lg text-white rounded-l-lg bg-ipn text-center">Nuevo Usuario</p>
            </div>
            <div class="px-5">
                <form action="{{ route('guardar') }}" class="flex flex-col items-center justify-center w-full py-10 justify-items-center" method="POST">
                    ...
                    @endif
                    {{-- Input 1 y 2 --}}
                    <div class="flex flex-col md:flex-row w-8/12 md:space-x-10 ">
                    ...
                    <div class="flex flex-col md:flex-row space-y-5 md:space-y-0 py-10 md:space-x-10 justify-evenly">
                        ...
                        <button class="px-10 py-3 font-bold text-white rounded-md bg-ipn">Guardar</button>
                    </div>
                </form>
            </div>
        </div>
