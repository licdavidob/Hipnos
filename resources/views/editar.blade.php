<x-app-layout>
    <div class="p-10 m-5">
        <div class="shadow-md backdrop-blur-sm shadow-gray-400">
            ...
            <div class="px-5">
                <form action="{{ route('actualizar', $Usuario->ID_Usuario) }}"
                    class="flex flex-col items-center justify-center w-full py-10 justify-items-center" method="POST">
                    {{-- @dd($Usuario) --}}
                    @method('PUT')
                    @csrf
                    {{-- Div para errores --}}
                        ...
                        <div class="col-span-1">
                            <div class="flex flex-col items-center justify-center">
                                <div class="w-60 h-60 border-8 border-white shadow-lg">
                                    <img src="{{ $Usuario->QR->Ruta_Local }}" alt="QR code"
                                        class="w-full border-8 border-white">
                                </div>
                                ...
                                <div class="py-6">
                                    <div class="flex items-center justify-center w-full space-x-5">
                                        ...
                                        <div class="flex">
                                            ...
                                            <label for="Estatus"
                                                class="px-6 py-3 font-bold transition-colors duration-200 ease-in-out border-2 rounded-lg cursor-pointer select-none text-ipn border-ipn peer-checked:bg-ipn-dark peer-checked:text-white peer-checked:border-ipn-dark ">
                                                Activo </label>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="w-full lg:w-11/12 col-span-1 lg:-ml-10">
                            ...
                            <div class="flex w-full flex-col md:flex-row md:space-x-10">
                                ...
                                <div class="relative w-full my-2 overflow-hidden rounded-md">
                                    ...
                                    <input type="search" id="Ap_Paterno" name="Ap_Paterno"
                                        class="w-full pl-20 p-2.5 border-none rounded-r-md bg-ipn text-white placeholder:text-white text-sm focus:ring-transparent"
                                        placeholder="Apellido paterno" value="{{ $Usuario->Ap_Paterno }}" />
                                </div>
                            </div>
                            {{-- Input 3 y 4 --}}
                            <div class="flex w-full flex-col md:flex-row md:space-x-10">
                                <div class="relative w-full my-2 overflow-hidden rounded-md">
                                    ...
                                    <input type="search" id="Ap_Materno" name="Ap_Materno"
                                        class="w-full pl-20 p-2.5 border-none rounded-r-md bg-ipn text-white placeholder:text-white text-sm focus:ring-transparent"
                                        placeholder="Apellido materno" value="{{ $Usuario->Ap_Materno }}" />
                                </div>
                                <div class="relative w-full my-2 overflow-hidden rounded-md">
                                    <div
                                        class="absolute inset-y-0 left-0 flex items-center px-6 pointer-events-none bg-ipn-dark">
                                    ...
                                    <input type="search" id="Telefono" name="Telefono"
                                        class="w-full pl-20 p-2.5 border-none rounded-r-md bg-ipn text-white placeholder:text-white text-sm focus:ring-transparent"
                            ...
                            <div class="flex w-full flex-col md:flex-row md:space-x-10">
                                <div class="relative w-full my-2 overflow-hidden rounded-md">
                                    ...
                                    <select name="ID_Tipo_Usuario" id="ID_Tipo_Usuario"
                                        ...
                                        <option value="{{ $Usuario->Tipo_Usuario->ID_Tipo_Usuario }}">{{
                                            $Usuario->Tipo_Usuario->Tipo_Usuario }}</option>
                                        {{-- @endif --}}
                                        <option value="1" @if ($Usuario->Tipo_Usuario->ID_Tipo_Usuario == 1)
                                            selected="selected"
                                            @endif
                                            >Alumno</option>
                                        <option value="2" @if ($Usuario->Tipo_Usuario->ID_Tipo_Usuario == 2)
                                            selected="selected"
                                            @endif
                                            >Docente</option>
                                        <option value="3" @if ($Usuario->Tipo_Usuario->ID_Tipo_Usuario == 3)
                                            selected="selected"
                                            @endif
                                            >Mixto</option>
                                    </select>
                            ...
                            <div class="flex w-full flex-col md:flex-row md:space-x-10">
                                <div class="relative w-full my-2 overflow-hidden rounded-md">
                                    ...
                                    <input type="date" id="P_Inicio_Ingreso" name="P_Inicio_Ingreso"
                                        class="w-full pl-20 p-2.5 border-none rounded-r-md bg-ipn text-white placeholder:text-white text-sm focus:ring-transparent"
                                        placeholder="Ingreso" value="{{ $Usuario->Permiso->Inicio_Ingreso  }}" />
                                </div>
                                <div class="relative w-full my-2 overflow-hidden rounded-md">
                                    <div
                                        class="absolute inset-y-0 left-0 flex items-center px-6 pointer-events-none bg-ipn-dark">
                                    ...
                                    <input type="date" id="P_Fin_Ingreso" name="P_Fin_Ingreso"
                                        class="w-full pl-20 p-2.5 border-none rounded-r-md bg-ipn text-white placeholder:text-white text-sm focus:ring-transparent"
                                        placeholder="Salida" value="{{ $Usuario->Permiso->Fin_Ingreso  }}" />
                                </div>
                            </div>
                        </div>
                    </div>
